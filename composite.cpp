///////////////////////////////////////////////Composite Pattern/////////////////////////////////////////////////////////////////
//Composite lets clients treat individual objects and compositions of objects uniformly. The Composite pattern can represent both the conditions. In this pattern,//
...
public:
  void print() const {
    ...
    for_each(graphicList.begin(), graphicList.end(), [](Graphic* a){a->print();});
  }
